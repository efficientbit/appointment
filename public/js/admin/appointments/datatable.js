        ...
        a.init({
            src: $("#datatable_ajax"), onSuccess: function (a, e) {
                ...
                "columns": [
                    ...
                    { "data": "treatment_id","bSortable": true},
                ...
                "fnDrawCallback" : function(e) {
                    // Editing opitons for Doctor
                    $('.doctor').editable({
                        url: route('admin.appointments.save_doctor'),
                        title: 'Change Doctor',
                        ajaxOptions: {
                            type: 'put',
                            headers: {
                    ...
                    // Editing opitons for Treatment
                    $('.treatment').editable({
                        url: route('admin.appointments.save_treatment'),
