            ...
            <div class="table-container">
                ...
                <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                    ...
                    <tr role="row" class="heading">
                        ...
                        <th width="20%">@lang('global.locations.fields.actions')</th>
                    </tr>
                    <tr role="row" class="filter">
                        <td></td>
                        <td>
                            <input type="text" class="form-control form-filter input-sm" name="lead_status_name">
                        </td>
                        <td>
                            <input type="text" class="form-control form-filter input-sm" name="lead_status_fdo_name">
                        </td>
                        <td>
                            <input type="text" class="form-control form-filter input-sm" name="lead_status_fdo_phone">
                        </td>
                        <td>
                            <input type="text" class="form-control form-filter input-sm" name="lead_status_address">
                        </td>
                        <td>
                            {!! Form::select('lead_status_city', $cities, '', ['class' => 'form-control form-filter input-sm',]) !!}
                        </td>
                        <td>
