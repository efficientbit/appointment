...
@section('content')
    <div class="portlet light bordered">
        <div class="portlet-title">
            ...
            <div class="actions">
                <a href="{{ route('admin.doctors.index') }}" class="btn dark pull-right">@lang('global.app_back')</a>
            </div>
        </div>
        <div class="portlet-body form">
            <div class="form-group">
                {!! Form::model($doctor, ['method' => 'PUT', 'id' => 'form-validation', 'route' => ['admin.doctors.update', $doctor->id]]) !!}
                <div class="form-body">
