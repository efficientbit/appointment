        ...
        <div class="col-md-12 appoint-form">
            ...
            @if($cities)
                <div>
                    ...
                    @php( $array = ['lahore', 'karachi', 'islamabad', 'peshawar', 'lahore', 'lahore', 'lahore', 'lahore', 'lahore'])
                    @php( $counter = 0)
                    ...
                    <section class="checkbox-module dcenters-moduls">
                        @foreach($cities as $citie)
                            <div id="city_location{{ $citie->id }}" class="locations_outer" style="display: none;">
                                @if(count($citie->locations))
                                    @foreach($citie->locations as $location)
                                        <label>
                    ...
                    <section class="checkbox-module-step4">
                        <div class="col-md-12">
                            ...
                            <input id="mobile" name="phone" type="number" size="11" class="required custom-input" value="{{ $appointment->lead->patient->phone }}" placeholder="Patient Phone*">
                            <input id="full_name" name="full_name" type="text" class="required custom-input" value="{{ $appointment->lead->patient->full_name }}" placeholder="Patient Name*">
                        </div>
                        <div class="col-md-12">
