                ...
                @if($cities)
                    <div>
                        ...
                        <section class="checkbox-module-step4">
                            ...
                            <div class="col-md-12">
                                {!! Form::select('treatment_id', $treatments, null, ['id' => 'treatment_id', 'class' => 'required']) !!}
...
@section('javascript')
    ...
    <script type="text/javascript">
        function loadLead(phone, lead_id) {
            $.ajax({
                headers: {
                ...
                success: function(response){
                    if(response.status == '1'){
                        ...
                        $('#email').hide();
                        $('#lead_source_id').hide().removeAttr('class');
                    }
