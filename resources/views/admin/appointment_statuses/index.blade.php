...
@section('content')
    ...
    <div class="portlet light portlet-fit portlet-datatable bordered">
        <div class="portlet-title">
            ...
            <div class="actions">
                <a href="{{ route('admin.appointment_statuses.create') }}" class="btn btn-success">@lang('global.app_add_new')</a>
            </div>
        </div>
            ...
            <div class="table-container">
                ...
                <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                    ...
                    <tr role="row" class="heading">
                        ...
                        <th width="20%">@lang('global.appointment_statuses.fields.actions')</th>
                    </tr>
                    <tr role="row" class="filter">
                        <td></td>
                        <td>
                            <input type="text" class="form-control form-filter input-sm" name="appointment_status_name">
                        </td>
                        <td>
