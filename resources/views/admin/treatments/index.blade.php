...
@section('title')
    <!-- BEGIN PAGE TITLE-->
    <h1 class="page-title">@lang('global.treatments.title')</h1>
    <!-- END PAGE TITLE-->
@endsection
    ...
    <div class="portlet light portlet-fit portlet-datatable bordered">
        <div class="portlet-title">
            ...
            <div class="actions">
                ...
                <a href="{{ route('admin.treatments.sort') }}" class="btn btn-success">@lang('global.app_Sorttreatment')</a>
            </div>
        </div>
            ...
            <div class="table-container">
                ...
                <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                    ...
                    <tr role="row" class="heading">
                        ...
                        <th>@lang('global.treatments.fields.name')</th>
                        <th width="20%">@lang('global.treatments.fields.actions')</th>
                    </tr>
...
@section('javascript')
    ...
    <script src="{{ url('js/admin/treatments/datatable.js') }}" type="text/javascript"></script>
