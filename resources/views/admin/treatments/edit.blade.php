...
@section('content')
    <div class="portlet light bordered">
        <div class="portlet-title">
            ...
            <div class="actions">
                <a href="{{ route('admin.treatments.index') }}" class="btn dark pull-right">@lang('global.app_back')</a>
            </div>
        </div>
        <div class="portlet-body form">
            <div class="form-group">
                {!! Form::model($treatment, ['method' => 'PUT', 'id' => 'form-validation', 'route' => ['admin.treatments.update', $treatment->id]]) !!}
                    <div class="form-body">
                        <!-- Starts Form Validation Messages -->
                    @include('partials.messages')
                    <!-- Ends Form Validation Messages -->

                        @include('admin.treatments.fields')
                    </div>
...
@section('javascript')
    ...
    <script src="{{ url('js/admin/treatments/fields.js') }}" type="text/javascript"></script>
@endsection
